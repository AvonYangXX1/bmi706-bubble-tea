...
# Create a choropleth map using filtered data
...
def create_streamlit_app():
    ...
    # Selection between Country, Hemisphere, or WHO Region
...
# # Create a choropleth map using filtered data
# def create_choropleth(df_filtered, selected_year_week, subtype):
#     # Replace this path with the location of the downloaded Natural Earth shapefiles
#     shapefile_path = "path_to_shapefile/naturalearth_lowres.shp" 
